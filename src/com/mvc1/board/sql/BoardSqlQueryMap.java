package com.mvc1.board.sql;

public abstract class BoardSqlQueryMap {
	
	public static final String BOARD_KNO_CHAEBUNN = "SELECT NVL(MAX(SUBSTR((A.KNO), -3)), 0) + 1 COMNO FROM K_BOARD A";
	...
	public static String getSearcQuery(){
